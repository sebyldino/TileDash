////=====================    Type POPUP   ======================
function createPopup(device, item, $device, smallDevice, devices, ratio, extraID) {
    ...
    item.items.forEach(popupItem => {
        ...
        if (popupDevice || popupItemType === 'IMAGE' || popupItemType === 'VIRTUAL') {
            ...
            if (popupItem.capabilityID) $popupDevice.id = 'device-' + popupItem.id + '-' + popupItem.capabilityID + popupExtraID; 
            else $popupDevice.id = 'device-' + popupExtraID; 
            ...
            //?-----   type 
            if (popupItemType === 'SWITCH') createSwitch(popupDevice, popupItem, $popupDevice, smallDevice, devices, ratio, popupExtraID);
            else if (popupItemType === 'BUTTON') createButton(popupDevice, popupItem, $popupDevice, smallDevice, devices, ratio, popupExtraID);
            else if (popupItemType === 'IMAGE') createImage(popupDevice, popupItem, $popupDevice, smallDevice, devices, popupExtraID);
            else if (popupItemType === 'SENSOR') createSensor(popupDevice, popupItem, $popupDevice, smallDevice, devices, ratio, popupExtraID);
            else if (popupItemType === 'BINARY_SENSOR') createBinarySensor(popupDevice, popupItem, $popupDevice, smallDevice, devices, ratio, popupExtraID);
            else if (popupItemType === 'SLIDER') createSlider(popupDevice, popupItem, $popupDevice, smallDevice, devices, ratio, popupExtraID);
            else if (popupItemType === 'THERMOSTAT') createThermostat(popupDevice, popupItem, $popupDevice, smallDevice, devices, ratio, popupExtraID);
            else if (popupItemType === 'SHUTTER') createShutter(popupDevice, popupItem, $popupDevice, smallDevice, devices, ratio, popupExtraID);
            else if (popupItemType === 'VIRTUAL') createVirtual(popupDevice, popupItem, $popupDevice, smallDevice, devices, ratio, popupExtraID);
            else if (popupItemType === 'MEDIA') createMedia(popupDevice, popupItem, $popupDevice, smallDevice, devices, ratio, popupExtraID);
