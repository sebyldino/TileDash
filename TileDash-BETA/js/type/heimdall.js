...
function createHeimdall(device, item, $device, smallDevice, devices, ratio, extraID, smooth) {
    ...
    function createKeyPad() {
        ...
        for (let key = 1; key <= 11; key++) {
            ...
            $touchKey.classList.add('click');
            if (!smooth) $touchKey.classList.add('on');
