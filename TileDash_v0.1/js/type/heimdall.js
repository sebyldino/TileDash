...
function createHeimdall(device, item, $device, smallDevice, devices) {
    ...
    const popupWidth = tileWidth * heimdallPopupWidth + (heimdallPopupWidth + 1) * tileMargin;
    const popupHeight = tileHeight * heimdallPopupHeight + (heimdallPopupHeight + 1) * tileMargin;
